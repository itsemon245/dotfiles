  ...
  services.nginx.virtualHosts = {
    ${domain} = {
      ...
      extraConfig = ''
        ...
        proxy_read_timeout ${executionTime}s;
        fastcgi_read_timeout ${executionTime}s;
      '';
